...
class _EditProfileState extends State<EditProfile> {
  ...
  updateProfileData(){
  setState(() {
    displayNameController.text.trim().length<3||displayNameController.text.isEmpty?isDisplayNameValid=false:isDisplayNameValid=true;
    bioController.text.trim().length>100?isBioValid=false:isBioValid=true;
  });
